def get_uio66_params():
    ...
    # [atom_type] = q
    charge = {}
    charge['flexFF_Zr'] =  1.9480
    charge['flexFF_C1'] =  0.6300
    charge['flexFF_C2'] = -0.0820
    charge['flexFF_C3'] = -0.0650
    charge['flexFF_O1'] = -0.5400
    charge['flexFF_O3'] = -0.9100
    charge['flexFF_H1'] =  0.1330
